...
module.exports = (function() {
    ...
    router.all('/:ifName',
        function(req, res) {
            ...
            var callback = function (code, msg, data) {
                /** 
                 * 返回结果说明：
                 * 当返回code为200时，证明请求成功
            ...
            try {
                ...
                console.log(code);
                res.send({code:code,msg:code,data:code});
            }
        }
    );
    return router;
